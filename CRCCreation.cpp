...
#include "stdafx.h"
#include "CRCCreation.h"
#include "..\include\CRCCreation.h"
...
static const LPTSTR gpCFileName = L"CRCCreation.cpp";
...
void make_crc_table( void )  throw()
{
    int i, j;
...
/*
Table of CRC-32's of all single-unsigned char values (made by make_crc_table)
*/
static unsigned long crctable[ 256 ] = {
...
void CRC32_Update( unsigned long &crcvalue, const unsigned char data )
{
...
unsigned long CCheckSumCRC32::block_checksum(const void* data, const int& data_len)
{
    unsigned long crc;

    CRC32_InitChecksum( crc );
    CRC32_UpdateChecksum( crc, data, data_len);
